...
if __name__ == '__main__':
    ...
    ax1.plot(time, x_all[:, -1], color='k', linewidth=2)
    ...
    ax2.plot(time, x_all[:, -2], color='k', linewidth=2)
    ...
    ax3.plot(time, x_all[:, -3], color='k', linewidth=2)
    ...
    ax4.plot(u, x_all[:, -1], color='k', linewidth=2)
    ...
    ax5.plot(u, x_all[:, -2], color='k', linewidth=2)
    ...
    ax6.plot(u, x_all[:, -3], color='k', linewidth=2)
